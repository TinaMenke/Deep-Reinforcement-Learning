...
NUMBER_CLASS_TRANSLATION = {
    ...
    "Scenario3": [StationaryObjectCrossing],
...
class RouteScenario(BasicScenario):
    ...
    def __init__(self, world, config, debug_mode=False, criteria_enable=True, timeout=300):
        ...
        self._create_scenarios_along_route(
            world, ego_vehicle, config, debug_mode)
    ...
    def _update_route(self, world, config, debug_mode):
        ...
        if debug_mode:
            ...
            self._draw_waypoints(
                world, self.route, turn_positions_and_labels, vertical_shift=1.0, persistency=50000.0)
    ...
    def _update_ego_vehicle(self):
        ...
        ego_vehicle = CarlaActorPool.request_new_actor('vehicle.audi.tt',
                                                       elevate_transform,
                                                       rolename='hero',
                                                       hero=True)
    ...
    def _draw_waypoints(self, world, waypoints, turn_positions_and_labels, vertical_shift, persistency=-1):
        ...
        for w in waypoints:
            ...
            world.debug.draw_point(wp, size=0.1, color=carla.Color(
                0, 255, 0), life_time=persistency)
    ...
    def _build_master_scenario(self, world, ego_vehicle, route, town_name, timeout=300, debug_mode=False):
        ...
        # Take the last point and add as target.
        ...
        master_scenario_configuration.ego_vehicle = ActorConfigurationData('vehicle.audi.tt',
    ...
    def _build_scenario_instances(self, world, ego_vehicle, scenario_definitions, town, timeout=300, debug_mode=False):
        ...
        if debug_mode:
            for scenario in scenario_definitions:
                ...
                world.debug.draw_point(
                    loc, size=1.0, color=carla.Color(255, 0, 0), life_time=100000)
        ...
        for definition in scenario_definitions:
            ...
            scenario_configuration.ego_vehicles = [ActorConfigurationData('vehicle.audi.tt',
                                                                          ego_vehicle.get_transform(),
                                                                          'hero')]
            try:
